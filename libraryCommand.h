 ...
 * 
 * Description:
 *   - Class that encapsulates a variety of LibraryCommands that the library manager can execute
 * 
 * Implementation:
...
// ----------------------------------------------------------------------------
    ...
    * 
    * Executes this LibraryCommand object. This is pure virtual and must be implemented
    * in derived classes
    * @pre TBD
    * @post TBD
   */
